    ...
    return (
        ...
        <div className='bg-[#f8f8f8] w-full h-[70vh] relative flex items-center section'>
            <div className='xl:m-[20%] 2xl:m-[30%] z-10 lg:m-[10%] sm:m-[7%] m-[5%]'>
                ...
                <button className=" appearance-none bg-[#fc4a4e] rounded-md hover:shadow-md text-white  active:opacity-85 px-6 py-2 sm: text-xs lg:text-sm xl:text-lg">Shop Now</button>
            </div>
